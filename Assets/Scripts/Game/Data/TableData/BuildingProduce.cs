...
namespace Game.Data.TableData
{
    ...
    /// 
    [System.Serializable]
    public class BuildingProduce : UnityEngine.ScriptableObject 
    {	
        ...
        public BuildingProduceData[] dataArray;
        public List<BuildingProduceData> dataList;
    ...
    //#endif
            ...
            // 		
            dataArray ??= Array.Empty<BuildingProduceData>();
