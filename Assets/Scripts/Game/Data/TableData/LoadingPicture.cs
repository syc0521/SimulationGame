...
namespace Game.Data.TableData
{
    ...
    /// 
    [System.Serializable]
    public class LoadingPicture : UnityEngine.ScriptableObject 
    {	
        ...
        public LoadingPictureData[] dataArray;
        public List<LoadingPictureData> dataList;
    ...
    //#endif
            ...
            // 		
            dataArray ??= Array.Empty<LoadingPictureData>();
