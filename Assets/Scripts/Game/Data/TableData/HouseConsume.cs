...
namespace Game.Data.TableData
{
    ...
    /// 
    [System.Serializable]
    public class HouseConsume : UnityEngine.ScriptableObject 
    {	
        ...
        public HouseConsumeData[] dataArray;
        public List<HouseConsumeData> dataList;
    ...
    //#endif
            ...
            // 		
            dataArray ??= Array.Empty<HouseConsumeData>();
