...
namespace CriMana.Detail
{
	...
	#error unsupported platform
		...
		{
			// Note: This renderer use a deprecated API: CRIWARE89E02F24.
			// Todo: use CRIWARED618B369 with a c++ rendereDecoder class if needed.
			bool isFrameUpdated = CRIWARE89E02F24(
				playerId,
		...
		private static extern bool CRIWARE89E02F24(
			int player_id,
