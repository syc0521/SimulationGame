...
public class CriAtomExPlayer : CriDisposable
{
	...
	public override void Dispose()
	{
		...
		if (this.entryPoolHandle != IntPtr.Zero) {
			...
			CRIWARE348B99F2(this.entryPoolHandle);
		}
	...
	public void PrepareEntryPool(int capacity, bool stopOnEmpty)
	{
		...
		this.entryPoolHandle = CRIWAREF1DB6C3C(this.handle, capacity, this.max_path, stopOnEmpty);
		if (this.entryPoolHandle != IntPtr.Zero) {
	...
	public int GetNumEntries()
	{
		...
		return CRIWAREB0CA8CB3(this.entryPoolHandle);
	}
	...
	public int GetNumConsumedEntries()
	{
		...
		return CRIWAREF2104D05(this.entryPoolHandle);
	}
	...
	public bool EntryFile(CriFsBinder binder, string path, bool repeat)
	{
		...
		return CRIWARE5277731E(this.entryPoolHandle,
	...
	public bool EntryContentId(CriFsBinder binder, int contentId, bool repeat)
	{
		...
		return CRIWARE78E74FE0(this.entryPoolHandle,
								(binder != null) ? binder.nativeHandle : IntPtr.Zero,
								contentId,
								repeat);
	}
	...
	public bool EntryData(byte[] buffer, int size, bool repeat)
	{
		...
		return CRIWARE10CB0D07(this.entryPoolHandle, buffer, size, repeat);
	}
	...
	public bool EntryCue(CriAtomExAcb acb, string name, bool repeat)
	{
		...
		return CRIWARE59CCEB17(this.entryPoolHandle,
	...
	{
		if (this.entryPoolHandle != IntPtr.Zero) {
			CRIWAREBAFBC575(this.entryPoolHandle);
		}
	...
	public void Stop(bool ignoresReleaseTime)
	{
		...
		if (this.entryPoolHandle != IntPtr.Zero) {
			CRIWARE94DBB2A3(this.entryPoolHandle);
		}
	}
	...
	*/
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern IntPtr CRIWAREF1DB6C3C(IntPtr player, int capacity, int max_path, bool stopOnEmpty);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE348B99F2(IntPtr pool);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern int CRIWAREB0CA8CB3(IntPtr pool);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern int CRIWAREF2104D05(IntPtr pool);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREBAFBC575(IntPtr pool);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE5277731E(IntPtr pool, IntPtr binder, string path, bool repeat, int max_path);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE78E74FE0(IntPtr pool,  IntPtr binder, int id, bool repeat);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE10CB0D07(IntPtr pool, byte[] buffer, int size, bool repeat);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE10CB0D07(IntPtr pool, IntPtr buffer, int size, bool repeat);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE59CCEB17(IntPtr pool, IntPtr acbhn, string name, bool repeat);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE94DBB2A3(IntPtr pool);
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWAREF466419F(IntPtr player, bool sw);
	...
	private static IntPtr CRIWAREF1DB6C3C(IntPtr player, int capacity, int max_path, bool stopOnEmpty) { return new IntPtr(1); }
	private static void CRIWARE348B99F2(IntPtr pool) { }
	private static int CRIWAREB0CA8CB3(IntPtr pool) { return 0; }
	private static int CRIWAREF2104D05(IntPtr pool) { return 0; }
	private static void CRIWAREBAFBC575(IntPtr pool) { }
	private static bool CRIWARE5277731E(IntPtr pool, IntPtr binder, string path, bool repeat, int max_path) { return true; }
	private static bool CRIWARE78E74FE0(IntPtr pool,  IntPtr binder, int id, bool repeat) { return true; }
	private static bool CRIWARE10CB0D07(IntPtr pool, byte[] buffer, int size, bool repeat) { return true; }
	private static bool CRIWARE10CB0D07(IntPtr pool, IntPtr buffer, int size, bool repeat) { return true; }
	private static bool CRIWARE59CCEB17(IntPtr pool, IntPtr acbhn, string name, bool repeat) { return true; }
	private static void CRIWARE94DBB2A3(IntPtr pool) { }
	...
	private void CRIWAREF466419F(IntPtr player, bool sw) { _dummyLoop = sw; }
