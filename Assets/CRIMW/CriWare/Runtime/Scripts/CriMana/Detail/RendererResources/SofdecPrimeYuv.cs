...
#if UNITY_EDITOR_WIN || UNITY_STANDALONE_WIN || UNITY_PSP2 || UNITY_IOS || UNITY_TVOS || UNITY_WEBGL || UNITY_STANDALONE_LINUX || UNITY_STADIA
...
namespace CriMana.Detail
{
	...
	#error unsupported platform
		...
		protected override void OnDisposeUnmanaged()
		{
			CRIWAREE519EFD4(playerID, 0 ,null);
		...
		{
			CRIWARE5267266A(playerID, 0, new IntPtr[1]);
			hasRenderedNewFrame = false;
		...
		{
			bool isFrameUpdated = CRIWARE98318E69(playerId, 0, null, frameInfo, ref frameDrop);
		...
		public override void UpdateTextures()
		{
			...
			hasTextureUpdated |= CRIWARED618B369(playerID, numTextures, nativeTextures);
		}
	}
}
