...
namespace CriMana
{
	...
	public static class Settings
	{
		...
		{
			CriManaPlugin.CRIWARE9F182D39(enabled);
		}
...
public class CriManaPlugin
{
	...
	public static void SetConfigParameters(bool graphicsMultiThreaded, int num_decoders, int max_num_of_entries)
	{
		...
		CriManaPlugin.CRIWARECFA78B41((int)graphicsApi, enabledMultithreadedRendering, num_decoders, max_num_of_entries);
	...
	*/
	...
	public static void SetConfigAdditonalParameters_VITA(bool use_h264_playback, int width, int height)
	{
		...
		CriManaPlugin.CRIWAREECDA3874(use_h264_playback, (UInt32)width, (UInt32)height);
#endif
	}
	...
	public static void SetConfigAdditonalParameters_PC(bool use_h264_playback)
	{
		...
		CriManaPlugin.CRIWARE62B7B053(use_h264_playback);
#endif
	}
	...
	public static void SetConfigAdditonalParameters_WEBGL(string webworkerPath, uint heapSize)
	{
		...
		CriManaPlugin.CRIWARE866C30C7(webworkerPath,heapSize);
#endif
	}
	...
	{
		CriManaPlugin.CRIWARE06C87176();
	}

	public static void Unlock()
	{
		CriManaPlugin.CRIWARE46E1A37B();
	}

	#region DLL Import
	#if !CRIWARE_ENABLE_HEADLESS_MODE
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARECFA78B41(int graphics_api, bool graphics_multi_threaded, int num_decoders, int num_of_max_entries);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE7BFC56AA();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern bool CRIWARE611B78A5();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARED672C36F();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE9F182D39(bool flag);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE06C87176();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE46E1A37B();
...
#else
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern uint CRIWARE257CA763();
#endif

#if UNITY_EDITOR_WIN || (!UNITY_EDITOR && UNITY_STANDALONE_WIN)
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE62B7B053(bool enable);
#endif
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWAREECDA3874(bool use_h264_playback, UInt32 width, UInt32 height);
#elif !UNITY_EDITOR && UNITY_WEBGL
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern void CRIWARE866C30C7(string webworkerPath, uint heapSize);
#endif
	#else
	private static bool _dummyInitialized = false;
	private static void CRIWARECFA78B41(int graphics_api, bool graphics_multi_threaded, int num_decoders, int num_of_max_entries) { }
	private static void CRIWARE7BFC56AA() { _dummyInitialized = true; }
	public static bool CRIWARE611B78A5() { return _dummyInitialized; }
	private static void CRIWARED672C36F() { _dummyInitialized = false; }
	public static void CRIWARE9F182D39(bool flag) { }
	public static void CRIWARE06C87176() { }
	public static void CRIWARE46E1A37B() { }
	public static void criMana_UseStreamerManager(bool flag) { }
	public static bool criMana_IsStreamerManagerUsed() { return false; }
#if !UNITY_EDITOR && UNITY_WEBGL
#else
	public static uint CRIWARE257CA763() { return 0u; }
#endif
#if UNITY_EDITOR_WIN || (!UNITY_EDITOR && UNITY_STANDALONE_WIN)
	public static void CRIWARE62B7B053(bool enable) { }
#endif
#if !UNITY_EDITOR && UNITY_ANDROID
...
#endif
#elif !UNITY_EDITOR && UNITY_PSP2
	public static void CRIWAREECDA3874(bool use_h264_playback, UInt32 width, UInt32 height) { }
#elif !UNITY_EDITOR && UNITY_WEBGL
	public static void CRIWARE866C30C7(string webworkerPath, uint heapSize) { }
#endif
	#endif
	#endregion
}
