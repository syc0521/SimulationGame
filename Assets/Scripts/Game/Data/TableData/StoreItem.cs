...
namespace Game.Data.TableData
{
    ...
    /// 
    [System.Serializable]
    public class StoreItem : UnityEngine.ScriptableObject 
    {	
        ...
        public StoreItemData[] dataArray;
        public List<StoreItemData> dataList;
    ...
    //#endif
            ...
            // 		
            dataArray ??= Array.Empty<StoreItemData>();
