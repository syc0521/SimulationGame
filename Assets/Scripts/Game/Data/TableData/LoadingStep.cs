...
namespace Game.Data.TableData
{
    ...
    /// 
    [System.Serializable]
    public class LoadingStep : UnityEngine.ScriptableObject 
    {	
        ...
        public LoadingStepData[] dataArray;
        public List<LoadingStepData> dataList;
    ...
    //#endif
            ...
            // 		
            dataArray ??= Array.Empty<LoadingStepData>();
