...
namespace Game.Data.TableData
{
    ...
    /// 
    [System.Serializable]
    public class UIPanelTable : UnityEngine.ScriptableObject 
    {	
        ...
        public UIPanelTableData[] dataArray;
        public List<UIPanelTableData> dataList;
    ...
    //#endif
            ...
            // 		
            dataArray ??= Array.Empty<UIPanelTableData>();
