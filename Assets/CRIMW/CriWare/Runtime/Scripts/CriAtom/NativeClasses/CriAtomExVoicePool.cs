...
#error unsupported platform
	...
	{
		UsedVoicesInfo info;
		CRIWARED389B244((int)voicePoolId, out info.numUsedVoices, out info.numPoolVoices);
		return info;
	}
	...
	private static extern void CRIWARED389B244(int voice_pool_id, out int num_used_voices, out int num_pool_voices);
	...
	#endif
	#else
	private static void CRIWARED389B244(int voice_pool_id, out int num_used_voices, out int num_pool_voices)
