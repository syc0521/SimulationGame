...
{
	/* スクリプトバージョン */
	private const string scriptVersionString = "2.40.24";
	...
	{
		return CriFsPlugin.CRIWARE785081A5();
	}
	...
	{
		return CriAtomPlugin.CRIWAREA703719E();
	}
	...
	public static uint GetManaMemoryUsage()
	{
        ...
        return 0;
#else
		return CriManaPlugin.CRIWARE257CA763();
#endif
	}
	...
	public static extern int CRIWAREC8077C29();

	[DllImport(pluginName, CallingConvention = pluginCallingConvention)]
	public static extern void criWareUnity_SetRenderingEventOffsetForMana(int offset);
	#else
	public static int CRIWAREC8077C29() { return GetRequiredBinaryVersionNumber(); }
