...
namespace Game.Data.TableData
{
    ...
    /// 
    [System.Serializable]
    public class FeatureOpen : UnityEngine.ScriptableObject 
    {	
        ...
        public FeatureOpenData[] dataArray;
        public List<FeatureOpenData> dataList;
    ...
    //#endif
            ...
            // 		
            dataArray ??= Array.Empty<FeatureOpenData>();
