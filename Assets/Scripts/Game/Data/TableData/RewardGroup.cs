...
namespace Game.Data.TableData
{
    ...
    /// 
    [System.Serializable]
    public class RewardGroup : UnityEngine.ScriptableObject 
    {	
        ...
        public RewardGroupData[] dataArray;
        public List<RewardGroupData> dataList;
    ...
    //#endif
            ...
            // 		
            dataArray ??= Array.Empty<RewardGroupData>();
