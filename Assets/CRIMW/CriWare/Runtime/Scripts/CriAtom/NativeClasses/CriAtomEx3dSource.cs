...
public class CriAtomEx3dSource : CriDisposable
{
	...
	/**
	 * <summary>Confirmation of object destruction</summary>
	 * <remarks>
	 * <para header='Description'>Checks if an object can be destroyed. <br/>
	 * An object cannot be destroyed if it has been set to a CriAtomExPlayer. In this case, the function will return false.<br/></para>
	 * </remarks>
	 */
	...
	/**
	 * <summary>Getting the position of the 3D sound source</summary>
	 * <remarks>
	 * <para header='Description'>Gets the position of the 3D sound source.<br/>
	 * The position is returned as a 3D vector.<br/></para>
	 * </remarks>
	 */
