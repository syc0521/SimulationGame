...
namespace CriTimeline.Atom {
	...
	public partial class CriAtomClipWaveformPreviewer {
		...
		private static bool LoadWaveform(IntPtr acbHn, string cueName, ref System.Int16[] decodeLpcmBuffer) {
			...
			var result = CRIWARED2C8192E(acbHn, cueName, gcHandle.AddrOfPinnedObject(), decodeLpcmBuffer.LongLength);
			gcHandle.Free();
			return result;
		}
		...
		private static extern bool CRIWARED2C8192E(IntPtr acbHn, string cue_name, IntPtr decode_lpcm_buffer, System.Int64 decodeLpcmBufferLength);
#else
		private static bool CRIWARED2C8192E(IntPtr acbHn, string cue_name, IntPtr decode_lpcm_buffer, System.Int64 decodeLpcmBufferLength) {return false;}
#endif
		#endregion
	}
