 ...
 */
	public class Player : CriDisposable
	{
		...
		{
			get {
				return CRIWARE88D04318(playerId);
			}
		}
		...
		public Player(bool advanced_audio_mode, bool ambisonics_mode, uint max_path_length) {
			...
			if (advanced_audio_mode || max_path_length > 0) {
				playerId = CRIWARE95A85424(advanced_audio_mode, max_path_length);
				if (advanced_audio_mode) {
					/* AtomExPlayer 作成 */
					_atomExPlayer = new CriAtomExPlayer(CRIWARE165B6B70(playerId));
					if (ambisonics_mode) {
		...
		{
			CRIWARE18BFCB88(playerId, (sw) ? 1 : 0);
		...
		{
			return CRIWAREEFA5210A(playerId);
		}
		...
		public bool SetFile(CriFsBinder binder, string moviePath, SetMode setMode = SetMode.New)
		{
			...
			if (setMode == SetMode.New) {
				CRIWAREEDB46019(playerId, binderPtr, moviePath);
				return true;
			} else {
				return CRIWARE328F2911(
		...
		{
			if (setMode == SetMode.New) {
				CRIWARE7C753A2E(playerId, data, dataSize);
				return true;
			} else {
				return CRIWAREC35C3DC3(
		...
		*/
		...
		public bool SetContentId(CriFsBinder binder, int contentId, SetMode setMode = SetMode.New)
		{
			...
			if (setMode == SetMode.New) {
				CRIWAREB28B5D50(playerId, binder.nativeHandle, contentId);
				return true;
			}
			else {
				return CRIWAREDA0693CD(
		...
		{
			if (setMode == SetMode.New) {
				CRIWARE65553651(playerId, filePath, offset, range);
				return true;
			}
			else {
				return CRIWARE162DD162(
		...
		{
			CRIWARE4331E077(playerId, sw ? 1 : 0);
		}
		...
		public void SetMasterTimerType(TimerType timerType)
		{
			...
			CRIWAREBD24DE27(playerId, timerType);
		}
		...
		{
			CRIWARE705B8C6D(playerId, frameNumber);
		}
		...
		{
			CRIWAREAB576D15(playerId, speed);
		}
		...
		{
			CRIWARE3F9C5D06(playerId, maxDataSize);
		}
		...
		{
			CRIWARE6756AE56(playerId, min_buffer_size);
		}
		...
		{
			CRIWARED99932F6(playerId, track);
		}
		...
		public void SetAudioTrack(AudioTrack track)
		{
			if (track == AudioTrack.Off) {
				CRIWARED99932F6(playerId, -1);
			} else if (track == AudioTrack.Auto) {
				CRIWARED99932F6(playerId, 100);
			}
		}
		...
		{
			CRIWARE0EA59F65(playerId, track);
		}
		...
		{
			if (track == AudioTrack.Off) {
				CRIWARE0EA59F65(playerId, -1);
			} else if (track == AudioTrack.Auto) {
				CRIWARE0EA59F65(playerId, 100);
			}
		}
		...
		{
			CRIWARE213452EF(playerId, track);
		}
		...
		{
			if (track == AudioTrack.Off) {
				CRIWARE213452EF(playerId, -1);
			} else if (track == AudioTrack.Auto) {
				CRIWARE213452EF(playerId, 100);
			}
		}
		...
		{
			CRIWARE1FF2F5BE(playerId, volume);
		}
		...
		{
			return CRIWARED30C9C6F(playerId);
		}
		...
		{
			CRIWARE1EBB12C5(playerId, volume);
		}
		...
		{
			return CRIWARE966C4BA9(playerId);
		}
		...
		{
			CRIWARE0348BF1B(playerId, volume);
		}
		...
		{
			return CRIWAREC5A3A88D(playerId);
		}
		...
		{
			CRIWARE31668293(playerId, bus_name, level);
		}
		...
		{
			CRIWAREB2460D7A(playerId, bus_name, volume);
		}
		...
		{
			CRIWAREF4B0CC4E(playerId, bus_name, volume);
		}
		...
		public void SetSubtitleChannel(int channel)
		{
			...
			CRIWARE2C8FF595(playerId, channel);
		}
		...
		public long GetTime()
		{
			return CRIWARE7779586C(this.playerId);
		}
		...
		{
			return CRIWARE7500F0DD(this.playerId);
		}
		...
		{
			CRIWAREA7F6DE6B(this.playerId, asrRackId);
		}
		...
		public void UpdateWithUserTime(ulong timeCount, ulong timeUnit)
		{
			...
			CRIWAREC7C5CC77(this.playerId, timeCount, timeUnit);
			InternalUpdate();
		}
		...
		public void SetManualTimerUnit(ulong timeUnitN, ulong timeUnitD)
		{
			...
			CRIWAREA59E0F01(this.playerId, timeUnitN, timeUnitD);
		}
		...
		private void InternalUpdate()
		{
			...
			{
				CRIWARE1E785A43(playerId, _movieInfo);
		...
		private void PrepareNativePlayer()
		{
			if (cuePointCallback != null) {
				CRIWARED9F7168D(playerId, CuePointCallbackFromNative);
			}
			CRIWARE362A826C(playerId);
		}
		...
		private void UpdateNativePlayer()
		{
			...
			_nativeStatus = (Status)CRIWARE3CE8CE6A(playerId, subtitleBuffer, ref subtitleSizeTmp);
			...
			if (enableSubtitle) {
				var changed = CRIWARE725ED4B4(playerId);
				if (changed) {
					if (OnSubtitleChanged != null){
						OnSubtitleChanged(subtitleBuffer);
					}
					CRIWARE419ECAF8(playerId);
				}
			}
		...
		private static extern int CRIWAREFD186F02();
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern int CRIWARE72A5B8BF();
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern int CRIWARE95A85424(bool useAtomExPlayer, uint maxPathLength);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREABF659EC(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREEDB46019(int player_id, System.IntPtr binder, string path);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREB28B5D50(int player_id, System.IntPtr binder, int content_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE65553651(int player_id, string path, System.UInt64 offset, System.Int64 range);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE7C753A2E(int player_id, IntPtr data, System.Int64 datasize);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE7C753A2E(int player_id, byte[] data, System.Int64 datasize);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern bool CRIWARE328F2911(int player_id, System.IntPtr binder, string path, bool repeat);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern bool CRIWAREDA0693CD(int player_id, System.IntPtr binder, int content_id, bool repeat);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern bool CRIWARE162DD162(int player_id, string path, System.UInt64 offset, System.Int64 range, bool repeat);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern bool CRIWAREC35C3DC3(int player_id, IntPtr data, System.Int64 datasize, bool repeat);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern bool CRIWAREC35C3DC3(int player_id, byte[] data, System.Int64 datasize, bool repeat);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE66A63134(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern System.Int32 CRIWARE88D04318(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARED9F7168D(
			int player_id,
			CuePointCallbackFromNativeDelegate cbfunc
			);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE1E785A43(int player_id, [Out] MovieInfo movie_info);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern int CRIWARE3CE8CE6A(
			int player_id,
			System.IntPtr subtitle_buffer,
			ref uint subtitle_size
			);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE362A826C(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE61523A0C(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREBB898C91(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE705B8C6D(int player_id, int seek_frame_no);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREEB32FC73(int player_id, MovieEventSyncMode mode);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE18BFCB88(int player_id, int sw);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern bool CRIWAREEFA5210A(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE4331E077(int player_id, int sw);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern long CRIWARE7779586C(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern int CRIWARE33981CC9(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern IntPtr CRIWARE165B6B70(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern int CRIWARE7500F0DD(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARED99932F6(int player_id, int track);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE1FF2F5BE(int player_id, float vol);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern float CRIWARED30C9C6F(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE0EA59F65(int player_id, int track);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE1EBB12C5(int player_id, float vol);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern float CRIWARE966C4BA9(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE213452EF(int player_id, int track);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE0348BF1B(int player_id, float vol);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern float CRIWAREC5A3A88D(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE31668293(int player_id, string bus_name, float level);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREB2460D7A(int player_id, string bus_name, float level);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREF4B0CC4E(int player_id, string bus_name, float level);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE2C8FF595(int player_id, int channel);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREAB576D15(int player_id, float speed);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE3F9C5D06(int player_id, System.UInt32 max_data_size);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		public static extern void CRIWARE8A87737B(int player_id, float sec);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		public static extern void CRIWARE6756AE56(int player_id, int min_buffer_size);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		public static extern void CRIWAREA7F6DE6B(int player_id, int asr_rack_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREE2DF1163(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREBD24DE27(int player_id, TimerType timer_type);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREC7C5CC77(int player_id, ulong user_count, ulong user_unit);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWAREA59E0F01(int player_id, ulong timer_unit_n, ulong timer_unit_d);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE55ECC3E4(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARECEA2FA98(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern IntPtr CRIWARE27ED314F(int player_id, int bufferSize);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern bool CRIWARE725ED4B4(int player_id);
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		private static extern void CRIWARE419ECAF8(int player_id);
#if !CRIPLUGIN_USE_OLD_LOWLEVEL_INTERFACE
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		...
		private static int CRIWAREFD186F02() { return 0; }
		private static int CRIWARE72A5B8BF() { return 0; }
		private static int CRIWARE95A85424(bool useAtomExPlayer, uint maxPathLength) { return 0; }
		private static void CRIWAREABF659EC(int player_id) { }
		private static void CRIWAREEDB46019(int player_id, System.IntPtr binder, string path) { }
		private static void CRIWAREB28B5D50(int player_id, System.IntPtr binder, int content_id) { }
		private static void CRIWARE65553651(int player_id, string path, System.UInt64 offset, System.Int64 range) { }
		private static void CRIWARE7C753A2E(int player_id, IntPtr data, System.Int64 datasize) { }
		private static void CRIWARE7C753A2E(int player_id, byte[] data, System.Int64 datasize) { }
		private static bool CRIWARE328F2911(int player_id, System.IntPtr binder, string path, bool repeat) { return true; }
		private static bool CRIWAREDA0693CD(int player_id, System.IntPtr binder, int content_id, bool repeat) { return true; }
		private static bool CRIWARE162DD162(int player_id, string path, System.UInt64 offset, System.Int64 range, bool repeat) { return true; }
		private static bool CRIWAREC35C3DC3(int player_id, IntPtr data, System.Int64 datasize, bool repeat) { return true; }
		private static bool CRIWAREC35C3DC3(int player_id, byte[] data, System.Int64 datasize, bool repeat) { return true; }
		private static void CRIWARE66A63134(int player_id) { }
		private static System.Int32 CRIWARE88D04318(int player_id) { return 0; }
		private static void CRIWARED9F7168D(int player_id, CuePointCallbackFromNativeDelegate cbfunc) { }
		private static void CRIWARE1E785A43(int player_id, [Out] MovieInfo movie_info) { movie_info = new MovieInfo(); }
		private static int CRIWARE3CE8CE6A(int player_id, System.IntPtr subtitle_buffer, ref uint subtitle_size ) { return 0; }
		private void CRIWARE362A826C(int player_id) { _dummyPaused = false; _nativeStatus = Status.WaitPrep; }
		private void CRIWARE61523A0C(int player_id) { _dummyPaused = false; _nativeStatus = Status.WaitPrep; }
		private void CRIWAREBB898C91(int player_id) { _nativeStatus = Status.Stop;  }
		private static void CRIWARE705B8C6D(int player_id, int seek_frame_no) { }
		private static void CRIWAREEB32FC73(int player_id, MovieEventSyncMode mode){}
		private void CRIWARE18BFCB88(int player_id, int sw) { _dummyPaused = (sw == 1); }
		private static bool CRIWAREEFA5210A(int player_id) { return false; }
		private void CRIWARE4331E077(int player_id, int sw) { _dummyLoop = (sw == 1); }
		private static long CRIWARE7779586C(int player_id) { return 0; }
		private static int CRIWARE33981CC9(int player_id) { return 0; }
		private static IntPtr CRIWARE165B6B70(int player_id) { return new IntPtr(1); }
		private static int CRIWARE7500F0DD(int player_id) { return -1; }
		private static void CRIWARED99932F6(int player_id, int track) { }
		private static void CRIWARE1FF2F5BE(int player_id, float vol) { }
		private static float CRIWARED30C9C6F(int player_id){ return 0f; }
		private static void CRIWARE0EA59F65(int player_id, int track) { }
		private static void CRIWARE1EBB12C5(int player_id, float vol) { }
		private static float CRIWARE966C4BA9(int player_id){ return 0f; }
		private static void CRIWARE213452EF(int player_id, int track) { }
		private static void CRIWARE0348BF1B(int player_id, float vol) { }
		private static float CRIWAREC5A3A88D(int player_id){ return 0f; }
		private static void CRIWARE31668293(int player_id, string bus_name, float level) { }
		private static void CRIWAREB2460D7A(int player_id, string bus_name, float level) { }
		private static void CRIWAREF4B0CC4E(int player_id, string bus_name, float level) { }
		private static void CRIWARE2C8FF595(int player_id, int channel) { }
		private static void CRIWAREAB576D15(int player_id, float speed) { }
		private static void CRIWARE3F9C5D06(int player_id, System.UInt32 max_data_size) { }
		public static void CRIWARE8A87737B(int player_id, float sec) { }
		public static void CRIWARE6756AE56(int player_id, int min_buffer_size) { }
		public static void CRIWAREA7F6DE6B(int player_id, int asr_rack_id) { }
		private static void CRIWAREE2DF1163(int player_id) { }
		private static void CRIWAREBD24DE27(int player_id, TimerType timer_type) { }
		private static void CRIWAREC7C5CC77(int player_id, ulong user_count, ulong user_unit) { }
		private static void CRIWAREA59E0F01(int player_id, ulong timer_unit_n, ulong timer_unit_d) { }
		private static void CRIWARE55ECC3E4(int player_id) { }
		private static void CRIWARECEA2FA98(int player_id) {}
		private static IntPtr CRIWARE27ED314F(int player_id, int bufferSize){return IntPtr.Zero;}
		private static bool CRIWARE725ED4B4(int player_id){return false;}
		private static void CRIWARE419ECAF8(int player_id){}
		#endif
