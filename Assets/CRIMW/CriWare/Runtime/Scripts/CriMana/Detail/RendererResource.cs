...
namespace CriMana.Detail
{
	public abstract class RendererResource : System.IDisposable
	{
		...
		{
			return CRIWAREF14F77D8(playerId);
		}
		...
		protected static extern bool CRIWARE98318E69(
			int player_id,
			int num_textures,
		...
		[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
		protected static extern bool CRIWARED618B369(
			int player_id,
			int num_textures,
        ...
        [DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
        protected static extern bool CRIWARE5267266A(
            int player_id,
            int num_textures,
            [In, Out] System.IntPtr[] tex_ptrs
        );
        ...
        [DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
        protected static extern bool CRIWAREE519EFD4(
            int player_id,
            int num_textures,
            [In, Out] System.IntPtr[] tex_ptrs
        );
        ...
        [DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
        protected static extern sbyte CRIWAREF14F77D8(
            int player_id
        );
		#else
		protected static bool CRIWARE98318E69(
			int player_id,
			int num_textures,
			System.IntPtr[] tex_ptrs,
			[In, Out] FrameInfo frame_info,
		...
		protected static bool CRIWARED618B369(
			int player_id,
			int num_textures,
			[In, Out] System.IntPtr[] tex_ptrs
		) { return true; }

		protected static bool CRIWARE5267266A(
			int player_id,
			int num_textures,
			[In, Out] System.IntPtr[] tex_ptrs
		) { return true; }

		protected static bool CRIWAREE519EFD4(
			int player_id,
			int num_textures,
			[In, Out] System.IntPtr[] tex_ptrs
		) { return true; }

        protected static sbyte CRIWAREF14F77D8(
            int player_id
        ) { return 0; }
		#endif
		#endregion
