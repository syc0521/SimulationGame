...
public class CriFsBinder : CriDisposable
{
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern int CRIWAREF02BA103(uint id);
	...
	private static int CRIWAREF02BA103(uint id) { return 0; }
	#endif
...
public static class CriFsUtility
{
	...
	{
		/* User-Agent文字列を指定 */
		CRIWARECD0DC04A(userAgentString);
	}
	...
	{
		/* プロキシ設定 */
		CRIWARE48E31D64(proxyPath, proxyPort);
	}
	...
	{
		CRIWARE0C80F382(filter);
	}

	#region DLL Import
	#if !CRIWARE_ENABLE_HEADLESS_MODE
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARECD0DC04A(string userAgentString);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE48E31D64(string proxyPath, UInt16 proxyPort);

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern bool CRIWARE0C80F382(string filter);
	#else
	private static bool CRIWARECD0DC04A(string userAgentString) { return true; }
	private static bool CRIWARE48E31D64(string proxyPath, UInt16 proxyPort) { return true; }
	private static bool CRIWARE0C80F382(string filter) {return true; }
	#endif
	#endregion
}
...
public static class CriFsPlugin
{
	...
	public static void InitializeLibrary()
	{
		...
		/* ライブラリの初期化 */
		CriFsPlugin.CRIWARE601ABE43();
	}

	public static bool IsLibraryInitialized()
	{
		/* ライブラリが初期化済みかチェック */
		return CRIWARE1012AF20();
	}
	...
	public static void FinalizeLibrary()
	{
		...
		/* ライブラリの終了 */
		CriFsPlugin.CRIWARE74A6103A();
	}

	#region DLL Import
	#if !CRIWARE_ENABLE_HEADLESS_MODE
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE8451156E(
	...
	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE601ABE43();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern bool CRIWARE1012AF20();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	private static extern void CRIWARE74A6103A();

	[DllImport(CriWare.Common.pluginName, CallingConvention = CriWare.Common.pluginCallingConvention)]
	public static extern uint CRIWARE785081A5();
	...
	private static void CRIWARE8451156E(
		int num_loaders, int num_binders, int num_installers, int max_path, bool minimize_file_descriptor_usage, bool enable_crc_check) { }
	private static void CRIWARE601ABE43() { _dummyInitialized = true; }
	public static bool CRIWARE1012AF20() { return _dummyInitialized; }
	private static void CRIWARE74A6103A() { _dummyInitialized = false; }
	public static uint CRIWARE785081A5() { return 0u; }
