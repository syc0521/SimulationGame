...
namespace Game.Data.TableData
{
    ...
    /// 
    [System.Serializable]
    public class CityEvaluate : UnityEngine.ScriptableObject 
    {	
        ...
        public CityEvaluateData[] dataArray;
        public List<CityEvaluateData> dataList;
    ...
    //#endif
            ...
            // 		
            dataArray ??= Array.Empty<CityEvaluateData>();
